...
export function createShopping(container){
  container.innerHTML =`
  <button data-bs-toggle="modal" data-bs-target="#staticBackdrop" class="btn-car" ><img src="../img/shopping-cart.png" class="car" alt="car"></button>
  <div class="modal fade modal-container" id="staticBackdrop" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content w-100 mx-auto">
                            <div class="modal-body d-flex flex-column justify-content-center align-items-center gap-3">
                                <div class="d-flex  venta ">
                                    <img class= "img-cart"src="../img/dog-ball.jpg" alt="ball">
                                    <div class="shopping-info">
                                        ...
                                        <div class="cart-delete">
                                            <button class="btn-delete"><img src="../img/garbage.png" class="garbage" alt="garbage"></button>
                                            <p>5 Unidades</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex  venta ">
                                    ...
                                    <div class="shopping-info">
                                        ...
                                        <div class="cart-delete">
                                            <button class="btn-delete"><img src="../img/garbage.png" class="garbage redPath" alt="garbage"></button>
                                            <p>5 Unidades</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex cart-pago" style="width: 25rem;">
                                        <p>Total: $12541552</p>
                                    <div class="btn-pago">
